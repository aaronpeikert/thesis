...
The point is to set the goalpost and have a yardstick to measure how well a method aimed at improving empirical sciences does.

However, we can split $\mathcal{C}$ in complexity that can be formally described and a part that can only be evaluated subjectively.
...
Suppose we relax the second condition and have a "black box" that is repeatable on other data.
...
Relaxing the first condition most likely leads to relaxing the second condition as well.
...
To provide transparency, computational reproducibility must satisfy two requirements.
...
Addressing these four problems through automation lowers the barrier to understanding, making the inductive process transparent.
