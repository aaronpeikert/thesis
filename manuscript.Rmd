...
If the data does not yet exist, it cannot influence the results.
...
While this makes registration so difficult, it is exactly the information we need and from which the complexity of the inductive process might be derived.
