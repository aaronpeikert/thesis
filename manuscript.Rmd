...
# An information theorethic perspective on transparency in science
...
Information theory provides a rigorous mathematical measure that can be understood as the verisimilitude ("truth likeness") of a theory.
...
Most readers will recognize, that this information theoretic setup and the derivation below follow closely XXX in their derivation of the Akaike Information Criterion.
...
If the researcher did induce some quantities, transparency about what did happen is not enough; instead a transparency about what could have happened, had the data looked different, is required.
This information theoretic perspective one perspective that warrants transparency about the process of induction or equivalently about what could have happened.
What it means to establish this kind of transparency (the "how") will be discussed at length, however, before we continue, let me motivate the need for transparency about the process (the "what") using another perspective.

# A future performance perspective on transparency

There is another line of argumentation why transparency about the process of induction is important besides closeness to truth.
...
This insight connects the information theoretic setup with the process of cross validation, where the data is partitioned and the inductive process is repeated on each partition.
