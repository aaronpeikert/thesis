...
This work (version ``r repro::current_hash(backend = "gert")``) is made available online under the following source under the terms of the [Creative Commons Universal Public Domain Dedication | CC0](https://creativecommons.org/publicdomain/zero/1.0/):
