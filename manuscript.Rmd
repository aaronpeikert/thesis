...
Instead of verisimilitude one might be concerned with future performance. That is, how well does a theory do in predicting novel facts.
...
Again there exists some optimal $\theta_o$:

$$
\theta_{o} = \operatorname*{arg\,min}_\theta \mathcal{L}(x, g(\cdot|\theta))
$$
