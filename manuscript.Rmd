...
Highlighting the difficulties and attempting to overcome them are no recent trends, though they have been invigorated by the so-called replication crisis in psychology that also begins to ripple through other empirical sciences [@ioannidisWhyMostPublished2005; @opensciencecollaborationEstimatingReproducibilityPsychological2015].
...
Consider a placebo and an experimental group, it is possible to hypothesize and test a mean difference using a simple t-test.
...
In other words, induction gives theories some slack to be imprecise and contain "blank" spaces, later to be filled based on observation.
