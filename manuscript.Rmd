...
We are now interested in how much information is lost if we use $g(x)$, our theory, instead of $f(x)$, the reality, over all possible states $x$.
...
One follows in this section, and another is discussed in the next section.
...
We can, however, repeatedly sample data and repeat the inductive process.
