...
Some things cannot be made transparent in principle because some induction happens informally, so the complexity cannot be estimated with certainty.
...
To achieve transparency about the inductive process and ultimately about the empirical support of a theory, both bounds have to be increased. 
...
However, through the lens of transparency about the inductive process, it may be possible to further refine our view on computational reproducibility.
