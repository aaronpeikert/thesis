...
Therefore, I argue the problem is not induction but making transparent where and to what extent induction is used in the inferential process.
...
However, I aim to lay open the role of transparency in two frameworks that lend themselves to investigate induction.
